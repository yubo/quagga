 ...
 */
static inline void *bgp_node_info(const struct bgp_node *node)
{
	return node->info;
}
 ...
 * bgp_node_set_info
 */
static inline void bgp_node_set_info(struct bgp_node *node, void *info)
{
	node->info = info;
}
 ...
 * bgp_node_prefix
 */
static inline struct prefix *bgp_node_prefix(struct bgp_node *node)
{
	return &node->p;
}
 ...
 * bgp_node_prefixlen
 */
static inline u_char bgp_node_prefixlen(struct bgp_node *node)
{
 ...
 * @see bgp_table_top
 */
static inline struct bgp_node *bgp_table_top_nolock(const struct bgp_table
						    *const table)
{
 ...
 * bgp_table_top
 */
static inline struct bgp_node *bgp_table_top(const struct bgp_table *const
					     table)
{
 ...
 * bgp_node_lookup
 */
static inline struct bgp_node *bgp_node_lookup(const struct bgp_table *const
					       table, struct prefix *p)
{
 ...
 * bgp_node_match_ipv4
 */
static inline struct bgp_node *bgp_node_match_ipv4(const struct bgp_table
						   *table, struct in_addr *addr)
{
 ...
 * bgp_node_match_ipv6
 */
static inline struct bgp_node *bgp_node_match_ipv6(const struct bgp_table
						   *table,
