...
extern void bgp_check_local_routes_rsclient(struct peer *rsclient, afi_t afi,
					    safi_t safi);
...
extern void bgp_redistribute_add(struct prefix *, const struct in_addr *,
				 const struct in6_addr *, u_int32_t, u_char);
...
extern u_char bgp_distance_apply(struct prefix *, struct bgp_info *,
				 struct bgp *);
