      ...
      "Month of the year to expire\n" "Year to expire\n")
{
	...
	return key_lifetime_set(vty, &key->send, argv[0], argv[1], argv[2],
				argv[3], argv[4], argv[5], argv[6], argv[7]);
}
      ...
      "Month of the year to expire\n" "Year to expire\n")
{
	...
	return key_lifetime_set(vty, &key->send, argv[0], argv[2], argv[1],
				argv[3], argv[4], argv[5], argv[6], argv[7]);
}
      ...
      "Month of the year to start\n" "Year to start\n" "Never expires")
{
	...
	return key_lifetime_infinite_set(vty, &key->send, argv[0], argv[1],
					 argv[2], argv[3]);
}
      ...
      "Day of th month to start\n" "Year to start\n" "Never expires")
{
	...
	return key_lifetime_infinite_set(vty, &key->send, argv[0], argv[2],
					 argv[1], argv[3]);
}
      ...
      "Year to start\n" "Duration of the key\n" "Duration seconds\n")
{
	...
	return key_lifetime_duration_set(vty, &key->send, argv[0], argv[1],
					 argv[2], argv[3], argv[4]);
}
      ...
      "Year to start\n" "Duration of the key\n" "Duration seconds\n")
{
	...
	return key_lifetime_duration_set(vty, &key->send, argv[0], argv[2],
					 argv[1], argv[3], argv[4]);
}
