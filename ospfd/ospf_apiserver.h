...
extern void ospf_apiserver_clients_notify_ready_type9(struct ospf_interface
						      *oi);
...
extern int ospf_apiserver_handle_register_event(struct ospf_apiserver *apiserv,
						struct msg *msg);
extern int ospf_apiserver_handle_originate_request(struct ospf_apiserver
...
extern int ospf_apiserver_register_opaque_type(struct ospf_apiserver *apiserver,
					       u_char lsa_type,
					       u_char opaque_type);
extern int ospf_apiserver_unregister_opaque_type(struct ospf_apiserver
						 *apiserver, u_char lsa_type,
						 u_char opaque_type);
