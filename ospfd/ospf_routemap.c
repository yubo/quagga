...
{
	if (argc == 0)
		return ospf_route_match_delete(vty, vty->index, "ip next-hop",
					       NULL);
...
{
	if (argc == 0)
		return ospf_route_match_delete(vty, vty->index,
...
{
	if (argc == 0)
		return ospf_route_match_delete(vty, vty->index, "ip address",
					       NULL);
...
{
	if (argc == 0)
		return ospf_route_match_delete(vty, vty->index, "interface",
					       NULL);
...
{
	if (argc == 0)
		return ospf_route_set_delete(vty, vty->index, "metric-type",
					     NULL);
