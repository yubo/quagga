...
DEFUN(show_debugging_rip,
      show_debugging_rip_cmd, "show debugging rip", SHOW_STR DEBUG_STR RIP_STR)
{
...
DEFUN(debug_rip_events,
      ...
      "debug rip events", DEBUG_STR RIP_STR "RIP events\n")
{
...
DEFUN(debug_rip_packet,
      ...
      "debug rip packet", DEBUG_STR RIP_STR "RIP packet\n")
{
...
DEFUN(debug_rip_zebra,
      debug_rip_zebra_cmd,
      "debug rip zebra", DEBUG_STR RIP_STR "RIP and ZEBRA communication\n")
{
...
DEFUN(no_debug_rip_events,
      ...
      "no debug rip events", NO_STR DEBUG_STR RIP_STR "RIP events\n")
{
	rip_debug_event = 0;
	return CMD_SUCCESS;
}
...
DEFUN(no_debug_rip_packet,
      ...
      "no debug rip packet", NO_STR DEBUG_STR RIP_STR "RIP packet\n")
{
	rip_debug_packet = 0;
	return CMD_SUCCESS;
}
...
DEFUN(no_debug_rip_zebra,
      ...
      "no debug rip zebra",
      NO_STR DEBUG_STR RIP_STR "RIP and ZEBRA communication\n")
{
	rip_debug_zebra = 0;
	return CMD_WARNING;
}
