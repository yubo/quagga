...
#define INVALID_AFI 0
...
} mp_reach_segments[] = {
	{
		"IPv6", "IPV6 MP Reach, global nexthop, 1 NLRI", {
			/* AFI / SAFI */ 0x0, AFI_IP6, SAFI_UNICAST,
			    ...
			    0xaa, 0xbb, 0xcc, 0xdd,
			    0x3, 0x4, 0x5, 0x6, 0xa1, 0xa2, 0xa3, 0xa4,
			    /* SNPA (defunct, MBZ) */ 0x0,
			    /* NLRI tuples */ 32, 0xff, 0xfe, 0x1, 0x2,
			    /* fffe:102::/32 */
	}, (4 + 16 + 1 + 5),
		    SHOULD_PARSE, AFI_IP6, SAFI_UNICAST, VALID_AFI,}, {
	...
	0x0, 0x2, 0x0, 0x3,},
		...
		"IPv6-lnh",
			...
			/* AFI / SAFI */ 0x0, AFI_IP6, SAFI_UNICAST,
			    ...
			    0xaa, 0xbb, 0xcc, 0xdd,
			    0x3, 0x4, 0x5, 0x6, 0xa1, 0xa2, 0xa3, 0xa4,
			    /* Nexthop (local) */ 0xfe, 0x80, 0x0, 0x0,
			    /* fe80::210:2ff:.. */
			    0x0, 0x0, 0x0, 0x0,
			    0x2, 0x10, 0x2, 0xff, 0x1, 0x2, 0x3, 0x4,
			    /* SNPA (defunct, MBZ) */ 0x0,
			    /* NLRI tuples */ 32,
			    0xff, 0xfe, 0x1, 0x2,	/* fffe:102::/32 */
			    64, 0xff, 0xfe, 0x0, 0x1,	/* fffe:1:2:3::/64 */
		...
		"IPv6-nhlen", "IPV6 MP Reach, inappropriate nexthop length", {
		    ...
		    SHOULD_ERR, AFI_IP6, SAFI_UNICAST, VALID_AFI,}, {
	...
	0xaa, 0xbb, 0xcc, 0xdd,
			    0x3, 0x4, 0x5, 0x6,
			    0xa1, 0xa2, 0xa3, 0xa4,},
		    (4 + 16), SHOULD_ERR, AFI_IP6, SAFI_UNICAST, VALID_AFI,}, {
		...
		"IPv4", "IPv4 MP Reach, 2 NLRIs + default", {
		    ...
		    SHOULD_PARSE, AFI_IP, SAFI_UNICAST, VALID_AFI,}, {
		"IPv4-nhlen", "IPv4 MP Reach, nexthop lenth overflow", {
		    ...
		    SHOULD_ERR, AFI_IP, SAFI_UNICAST, VALID_AFI,}, {
	    ...
	    /* From bug #385 */
	{
		"IPv6-bug", "IPv6, global nexthop, 1 default NLRI", {
			/* AFI / SAFI */ 0x0, 0x2, 0x1,
			    ...
			    0x00, 0x00, 0x00, 0x00,
			    0x02, 0x0c, 0xdb, 0xff, 0xfe, 0xfe, 0xeb, 0x00,
			    /* SNPA (defunct, MBZ) */ 0,
			    /* NLRI tuples *//* Should have 0 here for ::/0, but dont */
	}, 37, SHOULD_ERR, AFI_IP6, SAFI_UNICAST, VALID_AFI,}, {
		NULL, NULL, {
	0}, 0, 0}
};
...
#define RANDOM_FUZZ 35
	...
	if (tty)
		printf("%s",
		       (failed >
			oldfailed) ? VT100_RED "failed!" VT100_RESET :
